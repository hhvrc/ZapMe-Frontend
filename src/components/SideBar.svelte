<script lang="ts">
  ...
  $: if (!!$SessionTokenStore) {
    entries = [
      { name: 'Home', href: '/home', icon: { type: 'material', name: 'home' } },
      {
        name: 'Friends',
        href: '/friends',
        icon: { type: 'material', name: 'people' },
      },
      {
        name: 'Messages',
        href: '/messages',
        icon: { type: 'material', name: 'message' },
      },
      {
        name: 'Profile',
        href: '/profile',
    ...
    entries = [
      ...
      },
      {
        name: 'Register',
        href: '/register',
        icon: { type: 'material', name: 'person_add' },
      },
      {
        name: 'Reset Password',
        href: '/reset-password',
      ...
      },
      {
        name: 'Privacy Policy',
        href: '/privacy',
        icon: { type: 'material', name: 'privacy_tip' },
      },
      {
        name: 'Terms of Service',
        href: '/tos',
        icon: { type: 'material', name: 'gavel' },
      },
      {
        name: 'Contact',
        href: '/contact',
        icon: { type: 'material', name: 'contact_support' },
      },
    ];
  }
  ...
  $: {
    ...
    if (!!config) {
      const { githubUri, twitterUri, redditUri, websiteUri } =
      ...
      if (githubUri)
        socials.push({
          ...
          icon: {
            type: 'uri',
            darkUri: '/icons/logo_github_white.svg',
            lightUri: '/icons/logo_github_black.svg',
          },
        });

      socials.push({
        name: 'Discord',
        href: config.contact!.discordInviteUrl!,
        icon: {
          type: 'uri',
          darkUri: '/icons/logo_discord_clyde_blurple.svg',
          lightUri: '/icons/logo_discord_clyde_blurple.svg',
        },
      });
      ...
      if (twitterUri)
        socials.push({
          ...
          icon: {
            type: 'uri',
            darkUri: '/icons/logo_twitter.svg',
            lightUri: '/icons/logo_twitter.svg',
          },
        });
      ...
      if (redditUri)
        socials.push({
          ...
          icon: {
            type: 'uri',
            darkUri: '/icons/logo_reddit.svg',
            lightUri: '/icons/logo_reddit.svg',
          },
        });
  ...
  <aside>
    {#each entries as { name, icon, href }}
      <a class="usn" {href}>
        {#if icon.type === 'uri'}
          <img
            src={IsLightMode ? icon.lightUri : icon.darkUri}
            alt={name}
