...
static getRootAsRealtimeEventSessionUserLeft(bb:flatbuffers.ByteBuffer, obj?:RealtimeEventSessionUserLeft):RealtimeEventSessionUserLeft {
  return (obj || new RealtimeEventSessionUserLeft()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsRealtimeEventSessionUserLeft(bb:flatbuffers.ByteBuffer, obj?:RealtimeEventSessionUserLeft):RealtimeEventSessionUserLeft {
...
static createRealtimeEventSessionUserLeft(builder:flatbuffers.Builder, sessionIdOffset:flatbuffers.Offset, userIdOffset:flatbuffers.Offset):flatbuffers.Offset {
