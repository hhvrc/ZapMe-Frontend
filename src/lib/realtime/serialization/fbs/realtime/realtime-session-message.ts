...
static getRootAsRealtimeSessionMessage(bb:flatbuffers.ByteBuffer, obj?:RealtimeSessionMessage):RealtimeSessionMessage {
  return (obj || new RealtimeSessionMessage()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsRealtimeSessionMessage(bb:flatbuffers.ByteBuffer, obj?:RealtimeSessionMessage):RealtimeSessionMessage {
...
static createRealtimeSessionMessage(builder:flatbuffers.Builder, recepientUserIdsOffset:flatbuffers.Offset):flatbuffers.Offset {
