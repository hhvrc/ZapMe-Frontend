...
static getRootAsRealtimeEventSessionInviteReceived(bb:flatbuffers.ByteBuffer, obj?:RealtimeEventSessionInviteReceived):RealtimeEventSessionInviteReceived {
  return (obj || new RealtimeEventSessionInviteReceived()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsRealtimeEventSessionInviteReceived(bb:flatbuffers.ByteBuffer, obj?:RealtimeEventSessionInviteReceived):RealtimeEventSessionInviteReceived {
...
static startRealtimeEventSessionInviteReceived(builder:flatbuffers.Builder) {
...
static createRealtimeEventSessionInviteReceived(builder:flatbuffers.Builder, sessionIdOffset:flatbuffers.Offset, participantIdsOffset:flatbuffers.Offset):flatbuffers.Offset {
