...
export class RealtimeEventSessionInviteReceived {
  ...
  static getRootAsRealtimeEventSessionInviteReceived(
    bb: flatbuffers.ByteBuffer,
    obj?: RealtimeEventSessionInviteReceived
  ): RealtimeEventSessionInviteReceived {
    return (obj || new RealtimeEventSessionInviteReceived()).__init(
      bb.readInt32(bb.position()) + bb.position(),
      bb
    );
  }

  static getSizePrefixedRootAsRealtimeEventSessionInviteReceived(
    bb: flatbuffers.ByteBuffer,
    obj?: RealtimeEventSessionInviteReceived
  ): RealtimeEventSessionInviteReceived {
  ...
  static createRealtimeEventSessionInviteReceived(
    builder: flatbuffers.Builder,
    sessionIdOffset: flatbuffers.Offset,
    participantIdsOffset: flatbuffers.Offset
  ): flatbuffers.Offset {
