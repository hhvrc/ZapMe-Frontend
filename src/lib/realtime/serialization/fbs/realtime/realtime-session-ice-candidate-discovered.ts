...
static getRootAsRealtimeSessionIceCandidateDiscovered(bb:flatbuffers.ByteBuffer, obj?:RealtimeSessionIceCandidateDiscovered):RealtimeSessionIceCandidateDiscovered {
  return (obj || new RealtimeSessionIceCandidateDiscovered()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsRealtimeSessionIceCandidateDiscovered(bb:flatbuffers.ByteBuffer, obj?:RealtimeSessionIceCandidateDiscovered):RealtimeSessionIceCandidateDiscovered {
...
static endRealtimeSessionIceCandidateDiscovered(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static createRealtimeSessionIceCandidateDiscovered(builder:flatbuffers.Builder, candidateOffset:flatbuffers.Offset):flatbuffers.Offset {
