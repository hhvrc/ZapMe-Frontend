...
static getRootAsRealtimeSessionCreate(bb:flatbuffers.ByteBuffer, obj?:RealtimeSessionCreate):RealtimeSessionCreate {
  return (obj || new RealtimeSessionCreate()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsRealtimeSessionCreate(bb:flatbuffers.ByteBuffer, obj?:RealtimeSessionCreate):RealtimeSessionCreate {
...
static createRealtimeSessionCreate(builder:flatbuffers.Builder, userIdsOffset:flatbuffers.Offset):flatbuffers.Offset {
