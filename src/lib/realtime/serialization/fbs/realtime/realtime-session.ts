...
import { RealtimeSessionBody, unionToRealtimeSessionBody, unionListToRealtimeSessionBody } from '../../fbs/realtime/realtime-session-body.js';
...
static getRootAsRealtimeSession(bb:flatbuffers.ByteBuffer, obj?:RealtimeSession):RealtimeSession {
  return (obj || new RealtimeSession()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsRealtimeSession(bb:flatbuffers.ByteBuffer, obj?:RealtimeSession):RealtimeSession {
...
static createRealtimeSession(builder:flatbuffers.Builder, bodyType:RealtimeSessionBody, bodyOffset:flatbuffers.Offset):flatbuffers.Offset {
