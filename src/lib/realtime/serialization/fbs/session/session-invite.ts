...
export class SessionInvite {
  ...
  bb_pos = 0;
  __init(i: number, bb: flatbuffers.ByteBuffer): SessionInvite {
    this.bb_pos = i;
    this.bb = bb;
    return this;
  }

  static getRootAsSessionInvite(bb: flatbuffers.ByteBuffer, obj?: SessionInvite): SessionInvite {
    return (obj || new SessionInvite()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
  }

  static getSizePrefixedRootAsSessionInvite(
  ...
  static startSessionInvite(builder: flatbuffers.Builder) {
  ...
  static endSessionInvite(builder: flatbuffers.Builder): flatbuffers.Offset {
    const offset = builder.endObject();
    return offset;
  }

  static createSessionInvite(
    builder: flatbuffers.Builder,
    sessionIdOffset: flatbuffers.Offset,
    userIdsOffset: flatbuffers.Offset
  ): flatbuffers.Offset {
    SessionInvite.startSessionInvite(builder);
    SessionInvite.addSessionId(builder, sessionIdOffset);
    SessionInvite.addUserIds(builder, userIdsOffset);
    return SessionInvite.endSessionInvite(builder);
  }
}
