  ...
  private onMessage(msg: MessageEvent<string | ArrayBuffer | Blob>) {
    ...
    switch (serverMessage.messageType()) {
      case ServerMessageBody.hello: {
        ...
        console.log(
          '[WS] Received hello message',
          helloMessage.sessionId(),
          helloMessage.userId()
        );
        break;
      }
      case ServerMessageBody.goodbye:
        console.log(
          '[WS] Received goodbye message',
          serverMessage.message(new ServerMessage()).message()
        );
        break;
      ...
      case ServerMessageBody.message_global:
        console.log(
          '[WS] Received global message',
          serverMessage.message(new ServerMessage()).message()
        );
        break;
      case ServerMessageBody.ready:
        console.log(
          '[WS] Received ready message',
          serverMessage.message(new ServerMessage()).message()
        );
        break;
      case ServerMessageBody.NONE:
        console.error(
          '[WS] Received NONE message type',
          serverMessage.messageType()
        );
        break;
      default:
        console.error(
          '[WS] Received unknown message type',
          serverMessage.messageType()
        );
        break;
    }
